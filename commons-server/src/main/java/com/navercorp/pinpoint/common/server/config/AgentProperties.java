...
public class AgentProperties {
    ...
    // Service types whose agents do not send serviceType in the gRPC header (state is written with serviceTypeCode -1)
    @Value("${pinpoint.agent.missing-header-service-types:1400,1800,1550}")
    private Set<Integer> missingHeaderServiceTypeCodes; // Node(1400), Go(1800), Envoy(1550)
