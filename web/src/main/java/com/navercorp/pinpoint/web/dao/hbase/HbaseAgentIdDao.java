...
public class HbaseAgentIdDao implements AgentIdDao {
    ...
    @Override
    public void insert(AgentInfoBo agentInfoBo, long timestamp) {
        byte[] row = AgentIdRowKeyUtils.createRowKey(ServiceUid.DEFAULT.getUid(), agentInfoBo.getApplicationName(), agentInfoBo.getServiceTypeCode(), agentInfoBo.getAgentId());
