...
@Service
public class AgentListStatusService {

    private final AgentIdDao agentIdDao;
    private final boolean v2enabled;

    public AgentListStatusService(AgentIdDao agentIdDao,
    ...
    public void update(int serviceUid, String applicationName, int serviceTypeCode, String agentId, long agentStartTime,
        ...
        if (v2enabled) {
            agentIdDao.updateStatus(serviceUid, applicationName, serviceTypeCode, agentId, agentStartTime, eventTimestamp, agentLifeCycleState);
        }
    }
