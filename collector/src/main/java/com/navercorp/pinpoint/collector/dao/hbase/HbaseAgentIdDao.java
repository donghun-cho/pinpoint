...
public class HbaseAgentIdDao implements AgentIdDao {
    ...
    public void insert(int serviceUid, AgentInfoBo agentInfoBo) {
        byte[] rowKey = ServiceGroupRowKeyPrefixUtils.createRowKey(serviceUid, agentInfoBo.getApplicationName(), agentInfoBo.getServiceTypeCode(), AgentInfoBo.getAgentId());
