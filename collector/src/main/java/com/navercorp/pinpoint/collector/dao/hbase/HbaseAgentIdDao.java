...
public class HbaseAgentIdDao implements AgentIdDao {
    ...
    private static final byte[] AGENT_STATUS_QUALIFIER = HbaseTables.AGENT_ID_STATUS_QUALIFIER;
    ...
    @Override
    public void updateStatus(int serviceUid, String applicationName, int serviceTypeCode, String agentId, long agentStartTime,
        ...
        byte[] value = createStatusValueBytes(eventTimestamp, agentLifeCycleState);

        final Put put = new Put(rowKey, true);
        put.addColumn(DESCRIPTOR.getName(), AGENT_STATUS_QUALIFIER, value);
